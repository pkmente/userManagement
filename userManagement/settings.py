...
SECRET_KEY = 'django-insecure-6e_)*3zmp+^t=5wmv%alrwy*ic_ze9!ylet%w+uwubfx1nj(ev'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = "prabhukumarmente777@gmail.com"
EMAIL_HOST_PASSWORD = "lbsx nkbi yqlk qyfm"
